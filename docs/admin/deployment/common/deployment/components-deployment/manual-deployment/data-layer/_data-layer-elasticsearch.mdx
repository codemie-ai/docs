...
:::tip Not needed for standalone deployments
Deployments that set `RETRIEVAL_BACKEND=none` (see [Standalone Deployment](../../../../../standalone/overview.md)) do not require Elasticsearch. This section applies to the Kubernetes deployment path, where Elasticsearch remains required.
:::
