...
The domain configuration should already be set from the Getting Started section. Verify the values in <code>codemie-ui/values-{props.cloudName}.yaml</code> are correct.
...
- <code>-f ./codemie-ui/values-{props.cloudName}.yaml</code> - Uses {props.cloudProvider}-specific configuration
