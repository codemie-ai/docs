...
If you already have a provisioned EKS cluster with all required AWS services (networking, storage, databases, etc.), you can skip this section and proceed directly to [Components Deployment](../components-deployment/index.md).
:::
