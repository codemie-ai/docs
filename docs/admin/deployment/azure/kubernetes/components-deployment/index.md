...
:::info Prerequisites
This phase assumes you have completed [Infrastructure Deployment](../infrastructure-deployment/index.md) and have a running AKS cluster with network, storage, and security configured.
:::
