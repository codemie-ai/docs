...
:::info Infrastructure Diagram Coming Soon
Detailed infrastructure diagrams for Azure On VM are in progress. The table below describes all Azure resources provisioned by Terraform.
:::
...
| Resource                       | Purpose                                                              |
| ------------------------------ | -------------------------------------------------------------------- |
| **Azure VM (Standard_D8s_v5)** | Single VM running Docker Compose (8 vCPU, 32 GB RAM)                 |
...
| **Azure Bastion**              | Secure SSH/RDP access to the VM without exposing a public IP         |
