...
If you prefer automated deployment, see [Scripted Deployment](../scripted-deployment.md) instead.
:::
...
You must complete the Container Registry Access setup from the [Components Deployment Overview](../index.md#repository-and-access) before proceeding. Each component requires the `gcp-artifact-registry` pull secret to exist.
:::
...
### 1. [Kubernetes Components](./k8s-components.md)
...
### 3. [Security and Identity](./security-and-identity.md)
...
### 5. [AI/Run CodeMie Core](./core-components.mdx)
