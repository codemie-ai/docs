...
Detailed infrastructure diagrams for GCP On VM are in progress. The table below describes all GCP resources provisioned by Terraform.
:::
...
| Resource                       | Purpose                                                              |
| ------------------------------ | -------------------------------------------------------------------- |
| **GCE VM (n2-standard-8)**     | Single VM running Docker Compose (8 vCPU, 32 GB RAM)                 |
