...
- **Platform Components Logs**: Logs from core platform services (see [Core Components](../../deployment/aws/05-components-deployment/manual-deployment/05-core-components))
