...
- **Platform Components Logs**: Logs from core platform services (see [Core Components](../deployment/aws/kubernetes/components-deployment/manual-deployment/core-components.md))
