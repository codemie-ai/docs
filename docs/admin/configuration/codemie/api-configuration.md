...
| Parameter                                         | Type         | Default          | Description                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------------- | ------------ | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `LLM_PROXY_BUDGET_CHECK_ENABLED`                  | boolean      | `false`          | Enables LLM budget enforcement. When `true`, CodeMie actively enforces spending limits — requests from users or projects that have exceeded their budget are blocked. Also enables budget API routes and background budget maintenance. The `budgets-config.yaml` file is the source of truth: predefined budgets are synced into LiteLLM on startup (use `LLM_PROXY_BUDGET_SYNC_ENABLED` to apply config changes). |
