...
:::note
You can use scripts to create and manage User Password clients in Keycloak: [User Password Script](https://github.com/epam-gen-ai-run/ai-run-install/tree/main/scripts/keycloak_sdk)
:::
