...
:::note
You can use scripts to create and manage Client Secret clients in Keycloak: [Client Secret Script](https://github.com/epam-gen-ai-run/ai-run-install/tree/main/scripts/keycloak_api_client)
:::
