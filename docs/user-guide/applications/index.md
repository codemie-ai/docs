...
{ icon: 'user', title: 'EPAM sign-in', text: 'The same login as CodeMie. Hosted applications need no extra login step' },
...
{ icon: 'cycle', title: 'An automated release pipeline', text: 'Builds come from an EPAM repository, never copied by hand' },
...
['Sign-in', "The application's own EPAM login"],
],
effort: 1,
},
{
...
{ title: 'Access', text: 'Sign-in client, CodeMie project, and AI model access.', who: 'CodeMie team' },
...
{ title: 'Go-live', text: 'The tile is added and CodeMie is restarted. Hosted applications also deploy to production.', who: 'CodeMie team' },
