...
title: How to Work With Assistants
sidebar_position: 2
...
Learn the basics of creating and configuring assistants:
...
- [Create Custom Assistants](./create-custom-assistants) - Build assistants from scratch
...
Collaborate and preserve your work:

- [Share Chat Conversations](./share-assistant-chat-with-other-users) - Share conversations with team members
- [Export Assistant Chat Messages](./export-assistant-chat-messages-to-worddocx-and-pdf-formats) - Export chats to various formats

---

## Marketplace and Orchestration

:::info Community and Multi-Assistant Features
Discover community assistants or create complex multi-assistant workflows.
:::
