...
1. Download the plugin zip archive from: [GitHub Repository](https://github.com/epam-gen-ai-run/ai-run-community-tools/releases)
...
5. Select **Install Plugin from Disk**
   ![Install Plugin from Disk option](../images/image233.png)

6. Choose the downloaded zip archive
   ![File selection dialog](../images/image169.png)

7. Restart your IDE

[Video of installation](https://videoportal.epam.com/video/RY5qOQkY)

## Getting Started

### Initial Setup

1. Locate the Plugin: Find the CodeMie plugin icon in the right sidebar of your IDE
...
4. Assistant Access: Select from your available assistants
   ![Assistant selection interface](../images/image178.png)
