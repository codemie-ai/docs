...
![AI Katas Catalog](./images/katas-catalog.png)
...
![Details Mode](./images/kata-details-mode.png)

View Kata information and scroll through all steps in a standard details view.

### 2. Step-by-Step Mode

![Step by Step Mode](./images/kata-step-by-step-mode.png)
...
![Minimized Mode](./images/kata-minimized-mode-1.png)

![Minimized Mode with Navigation](./images/kata-minimized-mode-2.png)
