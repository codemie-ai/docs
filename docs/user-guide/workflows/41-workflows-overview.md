...
![Workflows tab in the navigation menu](../images/image94.png)
...
![Workflow categories view](../images/image65.png)
...
![Workflow actions menu](../images/image115.png)

### Starting a Workflow Execution

1. Click the **Start Execution** button on the workflow card:

   ![Start Execution button](../images/image172.png)

2. Enter your prompt in the New Workflow Execution window:

   ![New Workflow Execution window](../images/image133.png)
...
![Workflow Execution page](../images/image138.png)
...
![Abort and rerun buttons](../images/image201.png)

:::info
The abort button is only available while the workflow is actively executing.
:::

![Abort workflow button](../images/image231.png)
...
![Workflow execution history](../images/image4.png)
