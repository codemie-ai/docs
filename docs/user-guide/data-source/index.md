...
pagination_next: user-guide/data-source/data-source-overview/data-source-overview
---
...
Learn the fundamentals of data sources and indexing:
...
Connect and configure different types of data sources:

- [Add and Index Git Data Sources](./datasources-types/add-git-data-sources.md) - Connect and index Git repositories
- [Add and Index Confluence Pages](./datasources-types/add-confluence-pages.md) - Integrate Confluence documentation
- [Add and Index Jira Data Source](./datasources-types/add-jira-data-source.md) - Connect Jira projects and issues
