...
![Profile Menu](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_8-56-47.png)

![Settings Option](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_8-57-59.png)

### 2. Navigate to Administration

In the Settings panel, click on the **Administration** tab.

![Administration Tab](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_8-59-14.png)

### 3. Create a New Project

Click on the **Create Project** button.

![Create Project Button](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_9-4-16.png)

### 4. Enter Project Details

Fill in a unique **Project Name** (e.g., `sample_project`) and click **Add**.

![Project Creation Form](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_9-4-43.png)
...
![Empty Dropdown](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_9-8-51.png)

![Projects After Search](@site/docs/deployment-guide/common/images/user-configuration/image-2025-9-17_9-10-29.png)
